...
describe("UserController", () => {
  ...
  describe("updateProfile", () => {
    ...
    it("should throw ConflictException if email is changed", async () => {
      ...
      await expect(
        controller.updateProfile(req, { email: "new@example.com" }),
  ...
  describe("deleteProfile", () => {
    ...
    it("should throw NotFoundException if user not found", async () => {
      ...
      await expect(
        controller.deleteProfile(req, "nonexistent-id"),
    ...
    it("should throw ForbiddenException if access denied", async () => {
      ...
      await expect(controller.deleteProfile(req, mockUser.id)).rejects.toThrow(
        ForbiddenException,
      );
    });
  });

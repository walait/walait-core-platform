...
import type { SignUpInput } from '../interfaces/schemas/auth.schema';
...
export class UserService {
  ...
  async findByEmail(email: string, withPassword = false) {
    return this.userRepository.findOne({
      ...
      select: withPassword
        ...
        : ['id', 'email', 'is_email_verified', 'first_name', 'last_name', 'avatar_url', 'metadata'],
    });
  }
  ...
  async updateUser(user: User) {
    const existingUser = await this.userRepository.findOneByOrFail({ id: user.id });

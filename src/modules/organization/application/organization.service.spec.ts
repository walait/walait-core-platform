...
describe('OrganizationService', () => {
  ...
  describe('createOrganization', () => {
    it('should create a new organization if not exists', async () => {
      ...
      expect(repo.findOne).toHaveBeenCalledWith({
        where: [{ domain: organizationData.domain }, { slug: organizationData.slug }],
      });
    ...
    it('should throw ConflictException if domain or slug already exists', async () => {
      ...
      await expect(service.createOrganization(organizationData)).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('updateOrganization', () => {
    it('should update an existing organization', async () => {
      ...
      repo.save.mockResolvedValue({ ...organizationData, name: 'Updated' } as Organization);
    ...
    it('should throw ConflictException if domain or slug already exists', async () => {
      ...
      await expect(service.updateOrganization(organizationData)).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('getOrganizationById', () => {
    ...
    it('should throw NotFoundException if not found', async () => {
      ...
      await expect(service.getOrganizationById('org-1')).rejects.toThrow(NotFoundException);
    });
  });
